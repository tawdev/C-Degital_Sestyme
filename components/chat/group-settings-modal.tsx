                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="min-w-0">
                                                <p className="text-sm font-semibold text-gray-900 truncate flex items-center gap-2">
                                                    {member.full_name}
                                                    {isMe && <span className="bg-gray-100 text-gray-500 text-[10px] px-1.5 py-0.5 rounded">You</span>}
                                                </p>
                                            </div>
                                        </div>
                                        {canRemove && (
                                            <button
                                                ...
                                                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${isMe
